...
import pynab.openapi.models
from pynab.openapi import rest
from pynab.openapi.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pynab.openapi.models, klass)
