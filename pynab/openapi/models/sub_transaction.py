...
class SubTransaction(object):
    ...
    def __init__(self, id=None, transaction_id=None, amount=None, memo=None, payee_id=None, payee_name=None, category_id=None, category_name=None, transfer_account_id=None, transfer_transaction_id=None, deleted=None, local_vars_configuration=None):  # noqa: E501
